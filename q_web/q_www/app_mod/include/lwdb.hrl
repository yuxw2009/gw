-record(lw_register,{acc,device_id,login_uuid, pwd,deadline=date(),balance=0.0,chargeids=[], pls = [{gift_coins,100},{coins,0},{month_consumed,0},{month,0},{payids,[]}]}).  %group_id:common/dth/livecom/...    binary  

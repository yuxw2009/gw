...
(function () {
     ...
     * 
     */
    window.UEDITOR_HOME_URL = "/email/ueditor/";
    var URL;
    /**
    ...
    //    ,imageManagerPath:URL + "php/"                                    //图片修正地址，同imagePath
     ...
     //   ,getMovieUrl:URL+"php/getMovie.php"                   //视频数据获取地址
       ...
       ,toolbars:[
          [ 'source', '|', 'undo', 'redo', '|',
		  'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript','pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','selectall', 'cleardoc', '|',
		  'fontfamily', 'fontsize', '|',
		  'link', 'unlink','|',
		  'emotion','background', '|',    
		  'date', 'time', 'spechars', '|',  
		  'map','highlightcode','template','background',  'preview']
          ]

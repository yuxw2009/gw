   ...
   getdelete_name: function(obj){
	...
	create_sharefile: function(msg){
	    ...
	    html = ['<li class="hover '+ css +'" >',
			 ...
			 '<span class="opts">'+ openfile +'<a href="/lw_download.yaws?fid=' + msg.file_id + '" target="_blank" class="downloadFile">'+lw_lang.ID_DOWNLOAD+'</a>',
			 '<a href="javascript:void(0);" class="linkFile sharefiles">'+ lw_lang.ID_SHARE +'</a><a href="javascript:void(0);" class="linkFile delfile">'+lw_lang.ID_DELETE+'</a></span></em>',

...
get_response_auth(Nonce, Method, URIstr, User, Password, Realm) ->
    A1 = hex:to(erlang:md5([User, ":", Realm, ":", Password])),
    A2 = hex:to(erlang:md5([Method, ":", URIstr])),
    %%hex:to(erlang:md5([A1, ":", Nonce ,":",A2])).

	hex:to(erlang:md5([A1, ":", Nonce, ":","00000001",":", "G4bK276442331247",":","auth",":",A2])).
	
get_response(Nonce, CNonce, Method, URIstr, User, Password, Realm) ->
    A1 = hex:to(erlang:md5([User, ":", Realm, ":", Password])),
    A2 = hex:to(erlang:md5([Method, ":", URIstr])),
    hex:to(erlang:md5([A1, ":", Nonce, ":", CNonce, ":", A2])).	

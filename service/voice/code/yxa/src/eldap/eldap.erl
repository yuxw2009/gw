...
parse_attribute_type_and_value(Str) ->
	...
	{Rest,[]} ->
	    error(expecting_attribute_type);
	{Rest,Type} ->
...
parse_quotation(T,_) ->
    error(expecting_double_quote_mark).
...
parse_equal_sign(T)      -> error(expecting_equal_sign).

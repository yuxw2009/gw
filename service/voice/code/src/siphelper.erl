...
-export([
       generate_contact_str/1,
	 start_generate_request_1/6,
...
start_generate_request(Method, From, To, ExtraHeaders, Body) ->
    start_generate_request_1(Method, From, To, ExtraHeaders, Body,[{user, none}]).
start_generate_request_1(Method, From, To, ExtraHeaders, Body,UserInfos) ->

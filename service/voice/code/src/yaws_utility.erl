...
%%(voice@ZTE105601D02.zte.com.cn)19> yaws_utility:pl2jso([{aa,2},{bb,4}]).
%%{obj,[{aa,2},{bb,4}]}
%%(voice@ZTE105601D02.zte.com.cn)20> yaws_utility:pl2jsos([[{aa,2},{bb,4}]]).
%%[{obj,[{aa,2},{bb,4}]}]
%%(voice@ZTE105601D02.zte.com.cn)21> yaws_utility:pl2jsos([[{aa,2},{bb,4}],[{aa,3}
%%,{bb,565}]]).
%%[{obj,[{aa,2},{bb,4}]},{obj,[{aa,3},{bb,565}]}]
...
to_binary()-> 
    fun(A) when is_list(A)-> list_to_binary(A);
        (A) -> list_to_binary((to_string())(A))
    end.

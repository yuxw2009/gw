...
if(bClass)
{try{nCell.className+=' '+oCol.sClass;}catch(e){}}
if(!bVisible)
...
{sDataType=aoColumns[aDataSort[l]].sType;try{iTest=oSort[(sDataType?sDataType:'string')+"-"+aaSort[k][1]](aoData[a]._aSortData[aDataSort[l]],aoData[b]._aSortData[aDataSort[l]]);}catch(e){iTest="";}
if(iTest!==0)
{return iTest;}}}
if(""!==iTest){return oSort['numeric-asc'](aiOrig[a],aiOrig[b]);}});}

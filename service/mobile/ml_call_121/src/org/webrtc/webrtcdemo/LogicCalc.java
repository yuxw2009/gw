...
class LogicCalc
{
	static public String and(VoiceEngine webrtcAPI, int voiceChannel, List<Control> control, int method)
	{
		String status = "";
	...
	static public String or(VoiceEngine webrtcAPI,int voiceChannel,List<Control> control,int method)
	{
		String status = "";
